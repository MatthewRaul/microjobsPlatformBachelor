...
function LoginPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (!token) { setError("Tokenul lipsește din răspuns."); return; }
      await login(token);
      ...
      const backendMessage = err.response?.data?.message || "Email sau parolă greșită.";
      ...
      <div className="form-box">
        ...
        <form onSubmit={handleSubmit}>
          <div className="user-box">
            <input id="email" name="email" type="email" placeholder=" " value={formData.email} onChange={handleChange} />
